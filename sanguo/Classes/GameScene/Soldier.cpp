...
Soldier::Soldier(GameScene& scene, SoldierInfo& si)
    : m_scene(scene)
    , m_infoSoldier(si)
{
}
...
void Soldier::init(GameObjID oid, int nums, float xx, float yy, float dirx, float diry)
{
...
void Soldier::setPosition(float xx, float yy)
{
    m_ptPos.x = xx;
    m_ptPos.y = yy;
